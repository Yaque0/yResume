  ...
  <div class="resume-theme-box">
    <el-form label-width="120px" label-position="left">
      <el-form-item label="主题颜色:">
        <color-picker
          v-model:rgba="resumeJsonStore.GLOBAL_STYLE.themeColor"
        ></color-picker>
      </el-form-item>
      <!-- 字体大小设置 -->
...
<script lang="ts" setup>
  ...
  const defaultMtop: number = pxTonumber(
    resumeJsonStore.GLOBAL_STYLE.modelMarginTop,
  );
  ...
  // 下外边距
  console.log(resumeJsonStore.GLOBAL_STYLE);

  const defaultMbottom: number = pxTonumber(
    resumeJsonStore.GLOBAL_STYLE.modelMarginBottom,
  );
