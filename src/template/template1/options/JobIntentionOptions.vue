    ...
    <el-tab-pane label="数据配置" name="data">
      <el-form label-width="100px" label-position="left">
        ...
        <el-form-item label="求职类型:">
          <el-select
            v-model="modelItem.jobSearchType"
            class="m-2"
            placeholder="Select"
          >
        ...
        <el-form-item label="意向城市:">
          <el-input
            type="text"
            v-model="modelItem.intendedCity"
            maxlength="15"
            show-word-limit
          />
        ...
        <el-form-item label="期望薪酬:">
          <el-select
            v-model="modelItem.expectSalary"
            class="m-2"
            placeholder="Select"
          >
            <el-option
...
<script setup lang="ts">
  ...
  const modelItem = reactive<IJOBINTENTION>(
    resumeJsonStore.LIST[index] as IJOBINTENTION,
  );
  ...
  const jobStatusList: Array<string> = reactive([
    "随时入职",
    "一周内到岗",
    "一个月内到岗",
    "面议",
